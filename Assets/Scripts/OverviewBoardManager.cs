...
public class OverviewBoardManager : BaseBoard
{
    ...
    {
        // disclaimer: definitions generated by chatGPT, need to double-check later
        Dictionary<string, string> myDict = new()
        {
            {"Input", "This layer receives the raw data (e.g., images) for processing."},
            {"Convolutional 1", "This layer extracts initial spatial features using filters."},
            {"Activation 1", "This layer applies a non-linear activation function."},
            {"Convolutional 2", "This layer refines feature extraction by capturing more complex patterns."},
            {"Activation 2", "This layer introduces non-linearity after the second convolutional layer."},
            {"Pooling 1", "This layer reduces spatial dimensions to retain important features efficiently."},
            ...
            {"Convolutional 4", "This layer further extracts and refines high-level features."},
            {"Activation 4", "This layer adds non-linearity to enhance feature learning in deeper layers."},
            {"Pooling 2", "This layer further downsamples spatial dimensions to prepare for output."},
